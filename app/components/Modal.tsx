...
// * The Modal component is used to display the pokemon details. as of now it is
// * only used to display the pokemon images. and demonstrate the use of the
// * Transition component and the Dialog component from headlessui.
